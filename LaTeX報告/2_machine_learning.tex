...
在3D情況下，計算的基本單元為四面體，將原點與三角形的各個頂點連接形成一個四面體。三角形ACB具有法線NACB，四面體體積為:\\
$$\lvert V_OACB \rvert=\lvert \frac{1}{6}(-x_3 y_2 z_1 + x_2 y_3 z_1 + x_3 y_1 z_2 - x_1 y_3 z_2 - x_2 y_1 z_3 + x_1 y_2 z_3) \rvert$$
得到的值大小為四面體體積，值的正負由檢察原點是否在同一側來確認三角形法線的相對方向。\\
\begin{figure}[hbt!]
\begin{center}
