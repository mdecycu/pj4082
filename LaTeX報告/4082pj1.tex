...
left=3truecm,right=2truecm]{geometry}
...
\begin{center}   %標題
\makebox[1.5\width][s]
{\fontsize{24pt}{1pt}國立虎尾科技大學}\\[18pt]
\makebox[1.5\width][s]
{\fontsize{24pt}{1pt}機械設計工程系暨精密機械工程科}\\[18pt]
\makebox[1.5\width][s]
{\fontsize{24pt}{1pt}專題製作報告}\\[18pt]
...
%=---------------專題製作合可證明---------------------=%
 ...
 {\begin{center}
    {\fontsize{18pt}{2.5pt} {國立虎尾科技大學}[8pt]
    \hspace*{\fill} \\
    {機械設計工程系暨精密機械工程科}\\[8pt]
    \hspace*{\fill} \\
    {學生專題製作合格認可證明}\\[8pt]
    ...
    {\begin{minipage}[t]{10em}\underline{四設三甲\enspace 40823116\enspace 江東祐}\\ \underline{四設三甲\enspace 40823131\enspace 江建儒}\\ \underline{四設三甲\enspace 40823152\enspace 黃暐翰}\\ \underline{四設三甲\enspace 40823153\enspace 蕭日傑}\\ %下劃線符號指令
    \end{minipage}}
         \par} %結束指定行距
...
\input{2_physical environment.tex}
\input{3_virtual environment.tex}
\input{4_coordinate conversion.tex}
\input{5_pystl.tex}
\input{6_electrical system.tex}
...
%=-------------作者簡介-----------------=%
	...
	\end{figure}
	\end{textblock}}
	{\renewcommand\linespread{1.2}\selectfont %設定以下行距
	{\begin{textblock}{15}(3.5,0.7)%{寬度}(以左上角為原點之右移量,下移量)
	\noindent\fontsize{14pt}{2em}\selectfont \makebox[4em][s]{姓名}\enspace:\enspace
    \fontsize{14pt}{2em}\selectfont \makebox[4em][s]{江東祐}\\
    \hspace*{\fill} \\
    \fontsize{14pt}{2em}\selectfont \makebox[4em][s]{學號}\enspace:\enspace
    \fontsize{14pt}{2em}\selectfont \makebox[4em][s]{40823116} \\ %\makebox為文本盒子
    \hspace*{\fill} \\
    \fontsize{14pt}{2em}\selectfont \makebox[4em][s]{畢業學校}\enspace:\enspace
    \fontsize{14pt}{2em}\selectfont \makebox[9em][s]{國立虎尾科技大學}\\
    \fontsize{14pt}{2em}\selectfont \makebox[5em][s]{\quad}\enspace\enspace
    \fontsize{14pt}{2em}\selectfont \makebox[8em][s]{機械設計工程系}\\
    \end{textblock}}}
   % \hspace*{\fill} \\
   \vspace{2em}
    ...
    \noindent\fontsize{14pt}{2em}\selectfont \makebox[4em][s]{姓名}\enspace:\enspace
    \fontsize{14pt}{2em}\selectfont \makebox[4em][s]{江建儒}\\
    \hspace*{\fill} \\
    \fontsize{14pt}{2em}\selectfont \makebox[4em][s]{學號}\enspace:\enspace
    \fontsize{14pt}{2em}\selectfont \makebox[4em][s]{40823131} \\
    \hspace*{\fill} \\
    \fontsize{14pt}{2em}\selectfont \makebox[4em][s]{畢業學校}\enspace:\enspace
    \fontsize{14pt}{2em}\selectfont \makebox[9em][s]{國立虎尾科技大學}\\
    \fontsize{14pt}{2em}\selectfont \makebox[5em][s]{\quad}\enspace\enspace
    ...
    \noindent\fontsize{14pt}{2em}\selectfont \makebox[4em][s]{姓名}\enspace:\enspace%\noindent指定首行不進行縮排
    \fontsize{14pt}{2em}\selectfont \makebox[4em][s]{黃暐翰}\\
    \hspace*{\fill} \\
    \fontsize{14pt}{2em}\selectfont \makebox[4em][s]{學號}\enspace:\enspace
    \fontsize{14pt}{2em}\selectfont \makebox[4em][s]{40823152} \\ %\makebox為文本盒子
    \hspace*{\fill} \\
    \fontsize{14pt}{2em}\selectfont \makebox[4em][s]{畢業學校}\enspace:\enspace
    \fontsize{14pt}{2em}\selectfont \makebox[9em][s]{國立虎尾科技大學}\\
    \fontsize{14pt}{2em}\selectfont \makebox[5em][s]{\quad}\enspace\enspace
   ...
   \vspace{2em}
    ...
    \noindent\noindent\fontsize{14pt}{2em}\selectfont \makebox[4em][s]{姓名}\enspace:\enspace
    \fontsize{14pt}{2em}\selectfont \makebox[4em][s]{蕭日傑}\\
    \hspace*{\fill} \\
    \fontsize{14pt}{2em}\selectfont \makebox[4em][s]{學號}\enspace:\enspace
    \fontsize{14pt}{2em}\selectfont \makebox[4em][s]{40823153} \\
    \hspace*{\fill} \\
    \fontsize{14pt}{2em}\selectfont \makebox[4em][s]{畢業學校}\enspace:\enspace
    \fontsize{14pt}{2em}\selectfont \makebox[9em][s]{國立虎尾科技大學}\\
    \fontsize{14pt}{2em}\selectfont \makebox[5em][s]{\quad}\enspace\enspace
...
\vspace{4em}
\fontsize{30pt}{30pt}\selectfont 【15】 \\
